  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center '>
        <div className='m-30 bg-white dark:test-gray-200
        dark:bg-secondary-dark-bg h-44 rouded-xl w-full lg:w-80 p-8 pt-9 m-3
        bg-hero-pattern bg-no-repeat bg-cover bg-center'>
          <div className='justify-between items-center md:flex'>
              <div className='flex justify-between items-center'>
                <div>
                  <p className='font-bold text-gray-400'>Earnings</p>
                  <p className='text-gray-400'>Rs123456</p>
                </div>
              </div>
              <div className='mt-6'>
                <Button
          ...
          rounded-2xl md:w-780'>
            <div className='flex justify-between gap-10'>
              ...
              <div className='mt-10 flex gap-10 flex-wrap justify-center'>
                        ...
                        <div>
                          <p>
                            <span className='text-3xl font-semibold'>rs 12543</span>
